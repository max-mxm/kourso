...
const GUIDES: LandingContentItem[] = [
  {
    ...
    ogImage: '/api/og?title=Zod+:+Validation+TypeScript+Type-Safe&category=fundamentals',
  ...
  },
  {
    ...
    ogImage: '/api/og?title=TanStack+React+:+7+Librairies+Essentielles&category=optimization',
    twitterCard: 'summary_large_image',
  ...
  },
  {
    ...
    ogImage: '/api/og?title=React+19+:+Patterns+Avances&category=advanced',
    twitterCard: 'summary_large_image',
  ...
  },
  {
    ...
    ogImage: '/api/og?title=Next.js+16+:+Guide+Complet+des+Rendering+Modes&category=rendering',
    twitterCard: 'summary_large_image',
  ...
  },
  {
    ...
    ogImage: '/api/og?title=React+Memoisation+:+Le+Guide+Complet&category=optimization',
    twitterCard: 'summary_large_image',
